...
def initMessages():
    ...
    _messages["TK_MSG_USER_ADMIN_CMD_USERCONFIG"] = {
        "s": _("==> get user configuration and time information from the server, example")
    }
    ...
    _messages["TK_MSG_USER_ADMIN_CMD_SETPLAYTIMELIMITOVERRIDE"] = {
        "s": _("==> set whether PlayTime must be accounted instead of normal activity, example")
    }
    _messages["TK_MSG_USER_ADMIN_CMD_SETPLAYTIMEUNACCOUNTEDINTARVALSFLAG"] = {
        "s": _('==> set whether PlayTime activities are allowed during unaccounted ("∞") intervals, example')
    }
    ...
    _messages["TK_MSG_USER_ADMIN_CMD_SETPLAYTIMEACTIVITIES"] = {
        "s": _("==> set PlayTime activity process masks, for which the time is accounted, example")
    }
    ...
    _messages["TK_MSG_ADMIN_CHK_PLAYTIME_ENH_ACT_MON_ENABLED_INVALID_SET"] = {
        "s": _('PlayTime enhanced activity monitor flag "%%s" is not correct and cannot be set')
    }
    ...
    _messages["TK_MSG_USER_ADMIN_CHK_LOCKOUTTYPE_INVALID_SET"] = {
        "s": _('User\'s "%%s" restriction / lockout type is not correct and cannot be set')
    }
    ...
    _messages["TK_MSG_USER_ADMIN_CHK_PT_UNACC_INT_FLAG_NONE"] = {
        "s": _('User\'s "%%s" PlayTime allowed during unaccounted intervals flag is not passed')
    }
    _messages["TK_MSG_USER_ADMIN_CHK_PT_UNACC_INT_FLAG_INVALID"] = {
        "s": _('User\'s "%%s" PlayTime allowed during unaccounted intervals flag is not correct')
    }
    _messages["TK_MSG_USER_ADMIN_CHK_PT_UNACC_INT_FLAG_INVALID_SET"] = {
        "s": _('User\'s "%%s" PlayTime allowed during unaccounted intervals flag is not correct and cannot be set')
    }
    ...
    _messages["TK_MSG_USER_ADMIN_CHK_PT_DAYLIMITS_INVALID_SET"] = {
        "s": _('User\'s "%%s" PlayTime day limits list is not correct and cannot be set')
    }
    ...
    _messages["TK_MSG_CONFIG_LOADER_ERROR_GENERIC"] = {
        "s": _("Unexpected ERROR while loading configuration. Please inspect Timekpr-nExT log files")
    }
    # TRANSLATORS: this message must be 80 symbols long at max
    _messages["TK_MSG_CONFIG_LOADER_UNEXPECTED_ERROR"] = {
        "s": _("Unexpected ERROR getting configuration. Please inspect Timekpr-nExT log files")
    }
    # TRANSLATORS: this message must be 80 symbols long at max
    _messages["TK_MSG_CONFIG_LOADER_USER_UNEXPECTED_ERROR"] = {
        "s": _("Unexpected ERROR getting user configuration. Please inspect Timekpr-nExT log files")
    }
    # TRANSLATORS: this message must be 80 symbols long at max
    _messages["TK_MSG_CONFIG_LOADER_USERLIST_UNEXPECTED_ERROR"] = {
        "s": _("Unexpected ERROR getting user list. Please inspect Timekpr-nExT log files")
    }
    # TRANSLATORS: this message must be 80 symbols long at max
    _messages["TK_MSG_CONFIG_LOADER_SAVECONFIG_UNEXPECTED_ERROR"] = {
        "s": _("Unexpected ERROR updating configuration. Please inspect Timekpr-nExT log files")
    }
    # TRANSLATORS: this message must be 80 symbols long at max
    _messages["TK_MSG_CONFIG_LOADER_SAVECONTROL_UNEXPECTED_ERROR"] = {
        "s": _("Unexpected ERROR updating control. Please inspect Timekpr-nExT log files")
    }
    ...
    _messages["TK_MSG_STATUS_CONNECTION_ACCESS_DENIED"] = {
        "s": _("Please reopen the application if you are superuser and Timekpr-nExT is running")
    }
    ...
    _messages["TK_MSG_STATUS_PT_ALLOWED_UNLIMITED_INTERVALS_PROCESSED"] = {
        "s": _("PlayTime allowed during unaccounted intervals flag for the user has been processed")
    }
    ...
    _messages["TK_MSG_CONSOLE_USAGE_NOTICE_DAYS"] = {
        "s": _("weekdays are numbered according to ISO 8601 (i.e. Monday is the first day, format: 1-7)")
    }
    _messages["TK_MSG_CONSOLE_USAGE_NOTICE_HOURS"] = {
        "s": _("hours are numbered according to ISO 8601 (i.e. 24h clock, format: 0-23)")
    }
